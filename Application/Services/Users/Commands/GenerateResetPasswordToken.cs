...
public class GenerateResetPasswordTokenRequestModel : IRequest<GenerateResetPasswordTokenResponseModel>
{
    public string Host { get; set; }
    public string Email { get; set; }
}

public class GenerateResetPasswordTokenRequestModelValidator : AbstractValidator<GenerateResetPasswordTokenRequestModel>
{
...
public class GenerateResetPasswordTokenRequestHandler : IRequestHandler<GenerateResetPasswordTokenRequestModel, GenerateResetPasswordTokenResponseModel>
{
