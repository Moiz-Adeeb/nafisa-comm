...
public class UserController : BaseController
{
    ...
    {
        var model = new GetUserByIdRequestModel() { ChatId = id };
        return await Mediator.Send(model);
    }
    ...
    //[Authorize]
    //[HttpPost("password")]
    //public async Task<ChangePasswordResponseModel> ChangeCurrentPassword(
    ...
    //public async Task<UpdatePasswordByIdResponseModel> UpdatePasswordById(
    //    [FromRoute] string id,
    //    UpdatePasswordByIdRequestModel model
    //)
    //{
    //    model.Id = id;
    //    return await Mediator.Send(model);
    ...
    //[Authorize]
    //[HttpGet("dropDown")]
    //public async Task<GetUsersDropDownResponseModel> GetUsersDropDown(
    //    [FromQuery] GetUsersDropDownRequestModel model
    //)
    //{
    //    return await Mediator.Send(model);
    //}
    ...
    //[Authorize]
    //[HttpPost("link")]
    //public async Task<CreateUserWithLinkResponseModel> CreateUserWithLink(
    //    [FromBody] CreateUserWithLinkRequestModel model
    //)
    //{
    //    return await Mediator.Send(model);
    //}
    ...
    //[Authorize]
    //[HttpPut("me")]
    //public async Task<UpdateUserProfileResponseModel> UpdateUserProfile(
    //    [FromBody] UpdateUserProfileRequestModel model
    //)
    //{
    //    return await Mediator.Send(model);
    //}
    ...
    //[Authorize]
    //[HttpPut("{id}")]
    //public async Task<UpdateUserResponseModel> UpdateUser(
    //    [FromRoute] string id,
    //    [FromBody] UpdateUserRequestModel model
    //)
    //{
    //    model.Id = id;
    //    return await Mediator.Send(model);
    ...
    //public async Task<ResetPasswordResponseModel> ResetPassword(
    ...
    //public async Task<GenerateResetPasswordTokenResponseModel> GenerateResetPassword(
    //    GenerateResetPasswordTokenRequestModel model
    //)
    //{
    //    return await Mediator.Send(model);
    //}
